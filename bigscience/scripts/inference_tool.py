...
# PYTHONPATH=$(pwd)/bigscience/gins python3 bigscience/scripts/inference_tool.py --gin_file="bigscience/gins/enc_dec_xxl.gin" --gin_file="bigscience/gins/inference_tool.gin" --gin.MODEL_DIR="'/home/teven/model_dir'" --gin.INITIAL_CHECKPOINT_PATH="'/home/teven/checkpoints/enc_dec_c4_prefix_lm/checkpoint_65536'"
